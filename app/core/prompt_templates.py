...
"""
    ...
    FOLLOWER_LEADER_TYPE_RULES = {
        "王道型": (
            ...
            "4. 【阵营惯性-弱化版】追随不等于同盟，盟友可在特定议题上选择追随其他领导者（如经济追随敌对阵营）。前5轮内脱离现有阵营 → 追随意愿仅-20%（已大幅降低），允许议题性叛离。"
        ),
        "霸权型": (
            ...
            "4. 【阵营惯性-弱化版】追随不等于同盟，盟友可在特定议题上选择追随其他领导者（如经济追随敌对阵营）。前5轮内脱离现有阵营 → 追随意愿仅-15%（已大幅降低），允许议题性叛离。"
        ),
        "强权型": (
            "追随偏好：对追随行为持谨慎态度，偏好独立自主；如追随，优先选择军事实力显著强于本国的领导者；"
            "对合作型和道义型领导者持保留态度；参与领导竞争时强调军事实力和强制能力。"
            "【追随决策的量化评估标准】"
            "1. 评估候选领导者的军事指标（milex+milper）是否强于本国：若不强于 → 追随意愿-30%；"
            "2. 评估候选领导者是否提供安全保障：若对本国的主要威胁国采取过军事威慑/打击 → 追随意愿+25%；"
            "3. 强权型国家重视战略自主性，但也会在有明确利益时选择追随。当候选者能提供军事安全保障或实际利益时，追随是合理的战略选择；"
            "4. 评估候选者能否带来实际利益（经济合作、军事技术、安全保障等）：有实质性利益 → 追随意愿+15%；"
            "5. 【阵营惯性-弱化版】追随不等于同盟，盟友可在特定议题上选择追随其他领导者。前5轮内脱离现有阵营 → 追随意愿仅-15%，允许议题性叛离。"
        ),
        "昏庸型": (
            ...
            "4. 【阵营惯性-弱化版】追随不等于同盟，盟友可在特定议题上选择追随其他领导者（如经济追随敌对阵营）。前3轮内脱离现有阵营 → 追随意愿仅-10%（已大幅降低），允许议题性叛离。"
        )
    }
...
2. 【先核对战略关系-决策第一步】【重要：追随≠同盟】追随是对某国在特定议题上的领导偏好，不等同于战略同盟关系。你的战略关系（盟友/伙伴/冲突/战争）代表双边外交立场，而追随代表你在多边议题上的立场选择。盟友可能在经济议题上追随敌对阵营的领导者，这是正常的外交现象。评估每个可追随目标前，先在【你的战略关系总览】中核对该关系：
...
4. 考虑历史互动模式对决策的指导作用
5. 考虑国力变化趋势对战略选择的影响
6. 【中立与追随的平衡原则-适用于所有国家】在追随决策中，"中立"和"追随"都是理性选择。以下情况可考虑中立：
   - 你的国家利益不直接受该目标国影响
   - 你与所有目标国均无盟友/伙伴关系
   - 追随某一方会让你卷入不必要的冲突风险
   但请注意：中立并非总是最优选择。如果某国能为你提供实质利益（安全保障、经济支持、共同应对威胁），追随该国是理性的战略选择。小国也应积极评估追随的收益，而非默认中立。
...
【可追随目标评估（已为你预先核对你与每位国家的战略关系与双向互动统计）】
{candidates_evaluation}

【决策步骤-请严格按顺序执行】
1. 先排除：目标列表中标注 ⚠️【战争关系-禁止追随】的，原则上严禁选择
2. 再警惕：标注 ⚠️【冲突关系-应避免追随】的，仅在有明确战略利益时才考虑
3. 【关键步骤-追随收益评估】在考虑追随任何人之前，评估追随的收益与成本：
   - 追随≠同盟：追随是在特定议题上对某国领导偏好的表态，不是战略结盟。你可以在某个议题上追随非盟友的国家，也可以在某个议题上不追随你的盟友。
   - 追随是被动的：所有国家均可被追随，无需参选。你选择追随谁完全基于你的战略利益判断。
   - 追随是主动战略选择：追随意味着你在该议题上与某领导者协调立场，这可以带来实际的战略收益。
   - 以下情况应优先选择中立：
     a. 追随某一方会让你卷入与你无关的大国冲突，得不偿失
     b. 所有目标在当前议题上都没有为你提供明确的、具体的利益交换
   - 以下情况应积极考虑追随：
     a. 某国家在当前议题上为你提供了实质性的利益（安全保障、经济支持、领土保障等）
     b. 追随某方能帮助你在当前议题上获得你独自无法获得的利益
     c. 你与某国家在当前议题上有共同的对手或共同利益
     d. 你与某国家有盟友/伙伴关系，追随可以巩固和深化这一关系
     e. 某国家的领导类型与你的战略偏好契合（如你偏好道义型，对方是王道型）
4. 若确实有必要追随：按实力、领导类型、当前议题利益、双向互动统计选择最优目标
5. 【决策提示】中立（follower_agent_id = null）和追随都是合理选择。如果经过上述评估后仍有明确收益，应选择追随；如果收益不明确或风险过大，选择中立。
